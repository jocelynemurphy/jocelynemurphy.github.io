...
>
  <GridItem rowSpan={1} colSpan={1} bg='white' borderRadius="8px">
    <Center><Image src="./assets/gymbrosummer.png" maxW="100%" padding="5px"/></Center>
    <Text margin="-10px 40px 3vw 3vw">
        ロ do 1 chin up. 
        ...
        ロ join a dodgeball league 
    </Text>


  </GridItem>
  <GridItem rowSpan={1} colSpan={1} bg='#E3DED9' borderRadius="8px">
    <Center><Image src="./assets/hotgirlsummer.png" maxW="100%" padding="20px"/></Center>
    <Text margin="-30px 40px 3vw 3vw">
        ロ patio szn 🍹🌇
  ...
  <GridItem rowSpan={1} colSpan={1} bg='#E3DED9' borderRadius="8px">
    <Center><Image src="./assets/arthoesummer.png" maxW="100%" padding="20px"/></Center>
    <Text margin="-30px 40px 3vw 3vw">
        ロ make mini vlogs?
  ...
  <GridItem rowSpan={1} colSpan={1} bg='white' borderRadius="8px">
    <Center><Image src="./assets/techbrosummer.png" maxW="100%" padding="20px"/></Center>
    <Text margin="-30px 40px 3vw 3vw">
